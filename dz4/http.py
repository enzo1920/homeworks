...
class HttpServer(object):
    ...
    def accept_client(self):
        ...
        logging.info('client addr'+str(addr))
        client.setblocking(0)
        logging.info('epoll register client')
        try:
          logging.info(client.fileno())
...
def main():
    ...
    server = HttpServer('188.227.18.141', args.p, args.m)
    try:
        ...
        #     worker = multiprocessing.Process(target=server.accept_client())
