...
class LogisticRegression:
    ...
    def predict_proba(self, X, append_bias=False):
        ...
        ###########################################################################
        y_pred = self.sigmoid(X.dot(self.w.T))
    ...
    def loss(self, X_batch, y_batch, reg):
        ...
        hyp = self.sigmoid(X_batch.dot(self.w))
        loss = -np.dot(y_batch, np.log(hyp)) - np.dot((1-y_batch), np.log(1.0-hyp))
        dw = (hyp - y_batch) * X_batch
