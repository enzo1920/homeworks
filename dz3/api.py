...
class CharField(Field):
    def checker(self, value):
        if not isinstance(value, str):
            raise ValueError("Value not valid  type str")
        return value
...
class ArgumentsField(Field):
    def checker(self, value):
        if not isinstance(value, dict):
            raise ValueError("Value not valid  type dict")
        return value


class EmailField(CharField):
    def checker(self, value):
        value = super(EmailField, self).checker(value)
...
class DateField(Field):
    def checker(self, value):
        try:
            ...
            raise ValueError("DateFielde not valid ")
        return value
